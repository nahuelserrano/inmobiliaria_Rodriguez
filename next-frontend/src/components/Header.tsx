...
function PhoneIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className={styles.phoneIcon}>
  ...
  return (
    <header className={styles.header}>
      <div className={styles.inner}>
        <Link href="/" className={styles.brand} aria-label="Inmobiliaria Rodríguez, inicio">
        ...
        <div className={styles.actions}>
          <a className={styles.phone} href="tel:+542494575588">
            <PhoneIcon />
